...
import com.arash.altafi.weatherapp4.neumorphism_card_square_view.NeumorphismCardSquareView
...
import com.arash.altafi.weatherapp4.theme.getMainViewTopBarViewDateTextColor
import com.arash.altafi.weatherapp4.theme.getMainViewTopBarViewTextColor
import com.arash.altafi.weatherapp4.theme.getMainViewTopViewCardColor
    ...
    fun createUserAction(): MainViewTopBarViewContract.UserAction {
        if (preview) {
            return object : MainViewTopBarViewContract.UserAction {
                private var city = MutableLiveData("Tehran, Iran")
